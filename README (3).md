...
- **Live interactive prototype:** https://nakshathra1407.github.io/-ledgerly-prototype/
- **Source file (also included in this submission):** `ledgerly-interactive-prototype.html` (renamed to `index.html` for hosting)
